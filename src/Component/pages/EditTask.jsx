   ...
   return (
      <div className="add-new-task">
         <form onSubmit={handleSubmit(onSubmit)} className="form-new-task">
            <label>Title</label>
            <input
               className={`${errors.title ? "invalid-input" : "valid-input"}`}
               label="Title"
            ...
            <label>Creator</label>
            <input
               className={`${errors.creator ? "invalid-input" : "valid-input"}`}
               label="Creator"
               defaultValue={editTask.creator}
               placeholder="Name of Creator"
               {...register("creator", { required: true })}
            />
            {errors.creator && (
               <span className="error-msg">Creator is required</span>
            )}
            <br />
            ...
            <input
               type="date"
               className={`${
                  errors.createdAt ? "invalid-input" : "valid-input"
               }`}
               label="Created at"
               defaultValue={editTask.createdAt}
               placeholder="Created at"
               {...register("createdAt", { required: true })}
            />
            {errors.createdAt && (
               <span className="error-msg">Creation time is required</span>
            )}
            <br />
            ...
            <input
               className={`${
                  errors.description ? "invalid-input" : "valid-input"
               }`}
               label="Description"
